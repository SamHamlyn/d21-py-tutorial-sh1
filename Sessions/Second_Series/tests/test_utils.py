...
# import pandas as pd
# from pandas.api.types import is_datetime64_any_dtype as is_datetime # extra module to help to compare datetimes to each other
...
#     pd.testing.assert_series_equal(dmy_col, dmy_test_date)
...
def test_clean_903_table(dummy_header):   
    ...
    output_to_test = output[["ETHNICITY", "AGE", "AGE_BUCKETS", "MC_DOB_dt"]]

    pd.testing.assert_frame_equal(expected_df, output_to_test, check_names=False)